...
"ext_cash" => $_lang ['ext_cash'], "online_recharge" => $_lang ['online_recharge'], "offline_recharge" => $_lang ['offline_recharge'], "task_bid" => $_lang ['task_bid'], "task_fail" => $_lang ['task_fail'], "task_prom_fail" => $_lang ['task_prom_fail'], "sale_service" => $_lang ['sale_service'], "admin_recharge" => $_lang ['admin_recharge'], "withdraw_fail" => $_lang ['withdraw_fail'], "report" => $_lang ['report_processs'], "payitem" => $_lang ['payitem'], "prom_reg" => $_lang ['prom_reg'], "task_fj" => $_lang ['task_fj'], 'rights_return' => $_lang ['rights_return'], "task_auto_return" => $_lang ['task_auto_return'], 'order_cancel' => $_lang ['order_cancel'], "online_charge" => $_lang ['online_charge'], "order_charge" => $_lang ['order_charge'], 'prom_pub_task' => $_lang ['prom_pub_task'], 'prom_task_bid' => $_lang ['prom_bid_task'], 'enterprise_auth' => $_lang ['enterprise_auth'], 'task_remain' => $_lang ['task_remain_return'], 'hosted_return' => $_lang ['task_hosted_return'], 'admin_charge' => $_lang ['admin_charge'], 'host_deposit' => $_lang ['host_deposit'], 'deposit_return' => $_lang ['deposit_return'], 'host_return' => $_lang ['host_return'], 'host_split' => $_lang ['host_split'], 'task_lettory' => '任务摇奖', 'invoice_taxes' => '开票税金', 'buy_mobile' => '短信购买', 'credit_return' => '金币返还', 'task_pay' => '任务付款' );
...
;
	...
	*/
	public static function get_special_seocatname() {
		return array ('1' => 'rwzt', '2' => 'rczt', '3' => 'hdzt', '4' => 'qtzt' );
	}
	 ...
	 *获取认证状态ICO图标
	 */
	public static function get_auth_ico($auth_realname, $auth_mobile, $auth_email, $auth_bank) {
		global $_K;
		if ($auth_realname) {
	...
	public static function get_shop_level_ico($level) {
		...
		switch (intval ( $level )) {
			case 1 :
				$str .= "<a href='{$_K[siteurl]}/index.php?do=vip' target='_blank'>  <img src='" . SKIN_PATH . "/theme/{$_K['theme']}/img/ico/shop_level_1.png' alt='基础版商铺'> </a>";
				;
				break;
			case 2 :
				$str .= "<a href='{$_K[siteurl]}/index.php?do=vip' target='_blank'>   <img src='" . SKIN_PATH . "/theme/{$_K['theme']}/img/ico/shop_level_2.png' alt='VIP拓展版商铺'> </a> ";
				;
				break;
			case 3 :
				$str .= "<a href='{$_K[siteurl]}/index.php?do=vip' target='_blank'>   <img src='" . SKIN_PATH . "/theme/{$_K['theme']}/img/ico/shop_level_3.png' alt='VIP旗舰版商铺'>  </a>";
				;
				break;
		}
		return $str;
	...
	public static function get_w_level_ico($level) {
		...
		return "<a href='{$_K[siteurl]}/index.php?do=help&view=info&art_cat_id=611&art_id=6446' target='_blank'> <img src='" . SKIN_PATH . "/theme/{$_K['theme']}/img/ico/w_level_" . intval ( $level ) . ".gif' alt='威客能力等级'> </a>";
	}
	...
	public static function get_g_level_ico($level) {
		...
		return "<a href='{$_K[siteurl]}/index.php?do=help&view=info&art_cat_id=611&art_id=6446' target='_blank'>  <img src='" . SKIN_PATH . "/theme/{$_K['theme']}/img/ico/g_level_" . intval ( $level ) . ".gif' alt='雇主信誉等级'> </a>";
	}
	...
	public static function pay_return_notify($content, $type = 'online_recharge', $obj_id = '', $code = 'success') {
		...
		kekezu::show_msg ( '操作提示', $url, 3, $content, $code );
	}
