...
class taoapi_exception
{
    ...
    private function ErrorInfo ($errorcode)
    {
		...
		$errorinfo[592]=array('en'=>'Shop Seller Category Service Unavailable','cn'=>'威客自定义类目服务不可用');
		$errorinfo[594]=array('en'=>'Shop Seller Category Insert Error','cn'=>'威客自定义类目添加错误');
		$errorinfo[595]=array('en'=>'Shop Seller Category Update Error','cn'=>'威客自定义类目更新错误');
		$errorinfo[596]=array('en'=>'No Shop for This User','cn'=>'用户没有店铺');
		$errorinfo[597]=array('en'=>'Shop Seller Parent Category Error','cn'=>'威客自定义父类目错误');
		...
		$errorinfo[108]=array('en'=>'由于app有绑定昵称，而登录的昵称不是绑定昵称，所以没权限访问。','cn'=>'由于app有绑定昵称，而登录的昵称不是绑定昵称，所以没权限访问。');
