...
class taoapi_get {
	...
	/**
	 *根据威客昵称和商品ID列表获取SKU信息(taobao.item.skus.get)
	 */
	...
	/**
	 * 获取后台供威客发布商品的标准商品类目(taobao.itemcats.get)
	 */
	...
	/**
	 * 获取后台供威客发布商品的标准商品类目(taobao.itemcats.get.v2)
	 */
	...
	/**
	 * 获取前台展示的店铺内威客自定义商品类目(taobao.sellercats.list.get)
	 */
