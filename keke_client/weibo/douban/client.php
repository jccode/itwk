...
require_once 'DouBan/Extension/HttpRequest.php';
...
class OAuthClient
{
	...
	{
		//$httpRequest = new HttpRequest($oauthRequest->to_url());
		//var_dump($oauthRequest->to_url());
		//$headers = $oauthRequest->to_header();
		//var_dump($headers);die();
		//$httpRequest->addRequestHeader($headers['Authorization']);
		//$httpRequest->sendRequest();
		//var_dump($oauthRequest->build_request_url());die();
		var_dump($oauthRequest->to_url());
		$r = kekezu::curl_request($oauthRequest->to_url(),false);
