...
if($btn_sbt){
	...
	switch ($task_info['task_type']){
		case 1:
		default:
			$ext_arr['taskmodel'] = "普通招标";
			break;
		case 2:
			$ext_arr['taskmodel'] = "服务需求";
			break;
		case 3:
			$ext_arr['taskmodel'] = "直接雇佣";
			break;
	}
	($task_info['task_status']>=4&&$task_info['task_status']<9) and $ext_arr['ispay'] = "是" or $ext_arr['ispay'] = "否";
