...
$sql = "select b.task_id,a.username,a.task_id,a.work_id,b.task_title,a.work_desc,a.work_title,a.work_status from " . TABLEPRE . "witkey_task_work a left join " . TABLEPRE . "witkey_task b on a.task_id=b.task_id
...
// 行数
$sql_count = "select count(*) from " . TABLEPRE . "witkey_task_work a left join " . TABLEPRE . "witkey_task b on a.task_id=b.task_id where b.model_id='$model_id' " . $ex;
 ...
 * $work_arr= db_factory::query("select
 * b.task_id,b.username,a.task_id,a.work_id,a.work_title,a.work_desc,a.work_title,a.work_status
 * from ".TABLEPRE."witkey_task_work a left join ".TABLEPRE."witkey_task b on
 * a.task_id=b.task_id where b.model_id='$model_id'"); }
 */
