...
$prize_arr = db_factory::get_table_data('prize,prize_cash',"witkey_task_prize","task_id='$task_id'","prize","","","prize");
...
if ($sbt_act) { 
	...
	if($_POST ['work_status']){
		$_POST ['work_status'][11] or $_POST ['work_status'] = '1,2,3,4,5';
		...
		foreach ($member_list as $m){
			...
			if(!$task_info['lottery_config']){
				...
				$msg_obj->setValue("任务标题",$task_info['task_title']);
