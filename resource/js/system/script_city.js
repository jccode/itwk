...
function showprovince(provinceid, cityid, province,showWindow_id,jqform,province_search) {
	...
	if(province_search){
		var html = "<select name=\"" + provinceid + "\" id=\"" + provinceid + "\" onchange=\"setcity('" + provinceid + "', '" + cityid + "');province_search()\">";
	}else{
	...
	if(showWindow_id){
		var area_html = $("#"+showWindow_id).html().length;  
		if(area_html<1){
			$("#"+showWindow_id).html(html);  
	}
...
function showcity(cityid, city, provinceid,showWindow_id,city_search) {

	if(city_search){
		var html = "<select name=\"" + cityid + "\" id=\"" + cityid + "\"   onchange=\"city_search()\">";
	}else{
	...
	//alert(is_show);
	if(showWindow_id){ 
		var is_show = $("#"+showWindow_id).find("#"+cityid).length;
		if(is_show<1){
			$("#"+showWindow_id).append(html);
		}
