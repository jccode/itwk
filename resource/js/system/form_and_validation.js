...
function isMobileCN(s){
	...
	return patrn.test(s)||patrn2.test(s)||patrn3.test(s)||patrn4.test(s);
}
...
function ele_valid(id){
	...
	//var tips = obj.getAttribute('original-title')?obj.getAttribute('original-title'):(obj.getAttribute('title')?obj.getAttribute('title'):msg);
	var tips = msg;
