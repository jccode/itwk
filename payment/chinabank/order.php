...
function create_url($p){
    ...
    return "https://Pay3.chinabank.com.cn/PayGate?$arg";
}
...
function build_postform($p) {
	...
	$sHtml = $sHtml."<button type='button' name='v_action' value='网银确认付款' onClick='document.forms[\"E_FORM\"].submit();'>网银确认付款</button>";
	return $sHtml;
}
