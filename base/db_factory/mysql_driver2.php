...
final class mysql_drver2 extends DataBase {
	...
	function __construct($dbhost=null,$dbname=null,$dbuser=null,$dbpass=null,$dbcharset=null) {
		$dbhost and $this->_dbhost = $dbhost or $this->_dbhost = DataBase::$dbhost;
		$dbname and $this->_dbname = $dbname or $this->_dbname = DataBase::$dbname;
		$dbuser and $this->_dbuser = $dbuser or $this->_dbuser = DataBase::$dbuser;
		$dbpass and $this->_dbpass = $dbpass or $this->_dbpass = DataBase::$dbpass;
		$dbcharset and $this->_dbcharset = $dbcharset or $this->_dbcharset = DataBase::$dbcharset;
	}
	/**
	 * 数据库连接
	 *
