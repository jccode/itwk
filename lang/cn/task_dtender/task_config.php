...
//task_control_htm
	...
	'bidding_percentage_is'=>'招标提成比例是1%-99%',
	'bidding_percentage_range_is'=>'招标提成比例的范围是1%-99%，招标提成比例是计算招标成交金额的百分比',
 	'task_fail_percentage'=>'任务失败提成比例',
	'fail_bidding'=>'招标失败提成比例输入有误',
    'fail_bidding_percentage_is'=>'招标失败提成比例是1%-99%',
	'fail_bidding_commission_ratio_is'=>'招标提成比例的范围是1%-99%，招标提成比例是计算招标成交金额的百分比',
