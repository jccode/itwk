...
$dos = array ('config','modify','check_version','picture','review','get_indus','user', 'index', 'login', 'register', 'logout', 'upload', 'test', 'task', 'msg', 'release','search','release1','release2','release3','task_info','password');
