...
$url = "index.php?do=user&view=employer&op=taskneedpay";

$where = " where b.uid='$uid' and a.exec_time>0"; 
$sql_count = "select count(*) from ".TABLEPRE."witkey_task_work as a left join ".TABLEPRE."witkey_task b on a.task_id = b.task_id";
$sql_count .= $where;   
