...
if (isset($task_id)) {
	...
	$task_info ['uid'] != $uid && $uid != ADMIN_UID && $task_info ['task_status'] == 1 and kekezu::show_msg ( $_lang ['friendly_notice'], $_K['siteurl'].'/index.php?do=task_list', 2, $_lang ['task_auditing'] );
