...
if($sbt_edit){
	...
	$res and kekezu::admin_show_msg($_lang['service_edit_success'],"index.php?do=$do&model_id=7&view=list",2,$_lang['service_edit_success'],'success') or kekezu::admin_show_msg($_lang['service_edit_fail'],"index.php?do=$do&model_id=7&view=edit&service_id=".$service_id,2,$_lang['service_edit_fail'],'warning');
}
