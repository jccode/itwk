...
if(strpos($_SESSION['brandType'],'tw')!==false&&strpos('42,48', $target_id)===false){
	kekezu::admin_show_msg ( $_lang ['no_auth'], $_K['siteurl'].'/control/agent/index.php?do=tpl&view=ad', 3, '', 'error' );
	die();
}
